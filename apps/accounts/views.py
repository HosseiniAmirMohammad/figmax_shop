...
def dashboard_view(request):
    try:
        ...
        profile = Profile.objects.create(user=request.user, phone='', avatar='figmax-pfp1.png')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if form.cleaned_data['phone']:
                ...
                if Profile.objects.filter(phone=form.cleaned_data['phone']).exclude(user=user).exists():
